...
Меня зовут Николай, я junior специалист в области информационной безопасности.

- 🔐 Специализируюсь на penetration testing и применяю на практике свои знания в поиске и эксплуатации уязвимостей, понимаю основные типы атак и механизмы их реализации. Также разбираюсь в архитектуре Linux систем и принципах работы сетевого стека.
- 🛡️ Применяю на практике ключевые фреймворки и модели: MITRE ATT&CK, Cyber Kill Chain. Также знаком с базовыми стандартами ИБ: ISO/IEC 27001, NIST SP 800, PCI DSS.
- 🎓 Прошел профессиональную переподготовку по программе “Специалист по информационной безопасности” (Нетология). В настоящее время обучаюсь по направлению “Кибербезопасность цифрового предприятия” (Московский университет им. С.Ю. Витте).
- ⚡ Для меня информационная безопасность — это не только работа, но и мое хобби, я постоянно изучаю новые инструменты, актуальные киберугрозы и уязвимости, а также современные тренды в сфере кибербезопасности. 
...
![OWASP ZAP](https://img.shields.io/badge/-ZAP-purple?logo=owasp&logoColor=white) 
